...
This web page is an org-tangled version of my literate [[https://github.com/jsigman/dotfiles][dotfiles]].
...
** Pyrightconfig
#+include: "../extras/pyrightconfig.json" json

** Python project .dir-locals.el
#+include: "./extras/.dir-locals.el" emacs-lisp
